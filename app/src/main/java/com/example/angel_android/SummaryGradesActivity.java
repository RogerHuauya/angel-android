...
public class SummaryGradesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveButton.setText("Promediar");
        saveButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SummaryGradesActivity.this, LastActivity.class);
        ...
        JsonArrayRequest getRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                String id = courseObj.getString("exam_id");
                                String name = courseObj.getString("exam_name");
                                String grade = courseObj.getString("exam_grade");
                            ...
                            for (Exams exams : gradesList) {
                                ...
                                LinearLayout linearLayoutItem = new LinearLayout(SummaryGradesActivity.this);
                                ...
                                TextView textview1 = new TextView(SummaryGradesActivity.this);
                                ...
                                TextView textview2 = new TextView(SummaryGradesActivity.this);
                            ...
                            e.printStackTrace();
                            Toast.makeText(SummaryGradesActivity.this, "Error al procesar la respuesta", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(SummaryGradesActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }){
            @Override
